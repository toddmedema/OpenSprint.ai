 ...
 * Supports project-scoped broadcast and task-scoped agent output streaming.
...
class EventRelayService {
   ...
   * during setup.
   */
  init(projectClients: ProjectClientsMap, agentSubscriptions: AgentSubscriptionsMap): void {
