...
export const api = {
  ...
  prd: {
    ...
    getHistory: (projectId: string) =>
      request<unknown>(`/projects/${projectId}/prd/history`),
  },
  ...
  plans: {
    ...
    dependencies: (projectId: string) =>
      request<unknown>(`/projects/${projectId}/plans/dependencies`),
  },
  ...
  tasks: {
    ...
    ready: (projectId: string) =>
      request<unknown[]>(`/projects/${projectId}/tasks/ready`),
    get: (projectId: string, taskId: string) =>
      request<unknown>(`/projects/${projectId}/tasks/${taskId}`),
    ...
    session: (projectId: string, taskId: string, attempt: number) =>
      request<unknown>(
        `/projects/${projectId}/tasks/${taskId}/sessions/${attempt}`,
      ),
  },
  ...
  build: {
    ...
    status: (projectId: string) =>
      request<unknown>(`/projects/${projectId}/build/status`),
  },
  ...
  feedback: {
    ...
    get: (projectId: string, feedbackId: string) =>
      request<unknown>(`/projects/${projectId}/feedback/${feedbackId}`),
  },
