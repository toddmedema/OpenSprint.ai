...
function createMockAttachment(
  overrides: Partial<UseImageAttachmentReturn> = {}
...
describe("ImageAttachmentButton", () => {
  describe("icon variant tooltip", () => {
    ...
    it("does not show tooltip before hover delay", () => {
      ...
      render(<ImageAttachmentButton attachment={attachment} variant="icon" data-testid="attach" />);
  ...
  describe("text variant", () => {
    it("does not show tooltip on hover", () => {
      const attachment = createMockAttachment();
      render(<ImageAttachmentButton attachment={attachment} variant="text" data-testid="attach" />);
