...
export function PrdSectionEditor({
  ...
  return (
    <div
      ...
      className="prose prose-gray dark:prose-invert max-w-none prose-headings:text-gray-800 dark:prose-headings:text-gray-200 prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-li:text-gray-700 dark:prose-li:text-gray-300 prose-td:text-gray-700 dark:prose-td:text-gray-300 prose-th:text-gray-700 dark:prose-th:text-gray-300 prose-a:text-brand-600 dark:prose-a:text-brand-400 selection:bg-brand-100 dark:selection:bg-brand-900/40 min-h-[120px] p-4 rounded-lg border border-transparent hover:border-gray-200 dark:hover:border-gray-600 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 outline-none transition-colors empty:before:content-[attr(data-placeholder)] empty:before:text-gray-400 dark:empty:before:text-gray-500"
