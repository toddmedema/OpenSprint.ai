...
export function PrdChatPanel({
  ...
  const containerClass = isInline
    ? "flex flex-col h-full w-[380px] min-w-[320px] border-r border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 shrink-0 overflow-hidden"
  ...
  return (
    <div className={containerClass} data-testid={isInline ? "prd-chat-sidebar" : undefined}>
      {/* Chat header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-gray-700 bg-gray-50/80 dark:bg-gray-800/80 shrink-0">
        ...
        {!isInline && (
          <CloseButton
            ...
            className="p-1.5 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors"
            size="w-4 h-4"
          />
        )}
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        ...
        {sending && (
          <div className="flex justify-start">
            <div className="bg-gray-100 dark:bg-gray-700 rounded-2xl px-3.5 py-2.5 text-sm text-gray-400 dark:text-gray-500">
      ...
      {selectionContext && (
        <div className="mx-3 mb-1 px-3 py-2 bg-brand-50 dark:bg-brand-900/20 border border-brand-200 dark:border-brand-800 rounded-lg text-xs">
          <div className="flex items-center justify-between mb-1">
            ...
            <CloseButton
              ...
              className="p-0.5 text-brand-400 dark:text-brand-500 hover:text-brand-600 dark:hover:text-brand-300 hover:bg-transparent"
              size="w-3 h-3"
            />
          </div>
      ...
      {/* Error banner */}
      {error && (
        <div className="mx-3 mb-1 p-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-xs text-red-700 dark:text-red-400">
          {error}
      ...
      <div className="p-3 border-t border-gray-100 dark:border-gray-700 shrink-0">
        <div className="flex gap-2">
          <input
            ref={inputRef}
            type="text"
            className="flex-1 rounded-xl border-0 py-2.5 px-3.5 text-sm text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 shadow-sm ring-1 ring-inset ring-gray-200 dark:ring-gray-600 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-brand-500"
            value={chatInput}
