...
export function DreamPhase({ projectId, onNavigateToPlan }: DreamPhaseProps) {
  ...
  if (!hasPrdContent) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 relative bg-white dark:bg-gray-900">
        {/* Generating overlay */}
        {sending && (
        ...
        <div className="w-full max-w-2xl">
          <div className="relative">
            <textarea
              ...
              disabled={sending}
              rows={4}
              className="w-full rounded-2xl border-0 py-5 px-6 text-lg text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 shadow-lg ring-1 ring-inset ring-gray-200 dark:ring-gray-600 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-brand-500 resize-none transition-shadow hover:shadow-xl disabled:opacity-60"
            />
            <button
              type="button"
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <span className="text-xs text-gray-400 dark:text-gray-500">
              Press{" "}
              <kbd className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 font-mono text-[10px]">
                Enter
              </kbd>{" "}
              to submit
            </span>
        ...
        {error && (
          <div className="mt-6 w-full max-w-2xl p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-sm text-red-700 dark:text-red-400">
            {error}
            <button
              type="button"
              onClick={() => dispatch(setDesignError(null))}
              className="ml-2 text-red-500 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 underline"
            >
              Dismiss
            </button>
          </div>
  ...
  return (
    <div className="h-full flex overflow-hidden bg-white dark:bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 pb-24">
          <div className="flex items-center justify-between mb-8 sticky top-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm py-3 -mx-6 px-6 z-20 border-b border-transparent dark:border-gray-700">
      ...
      {selection && (
        ...
        >
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-xs font-medium rounded-lg shadow-lg hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors"
          >
