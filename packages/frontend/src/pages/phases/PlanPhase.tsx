                          ...
                          {selectedPlanTasks.length === 0 ? (
                            <div className="space-y-2">
                              ...
                              <button
                                ...
                                disabled={(planTasksPlanIds ?? []).includes(
                                  selectedPlan.metadata.planId
                                )}
                                className="btn-primary text-sm w-full py-2 disabled:opacity-60 disabled:cursor-not-allowed rounded-lg font-medium inline-flex items-center justify-center"
